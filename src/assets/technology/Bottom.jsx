...
const Bottom = () => {
    ...
    return (
        <Grid container sx={{ minHeight: "90%", display: "flex", flexDirection: "row-reverse", mt: 10, justifyContent: "space-around" }}>
            <Grid item xs={12} md={6} sx={{ display: "flex", justifyContent: "flex-end", alignItems: "center" }}>{matches==true?<img src={img} alt="image"  height={"auto"}  width={"100%"}></img> :<img src={img} height="auto" width="70%"></img>}</Grid>
